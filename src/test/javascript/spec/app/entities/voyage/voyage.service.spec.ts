...
describe('Service Tests', () => {
    describe('Voyage Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(VoyageService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/voyages';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Voyage', () => {
                service.create(new Voyage(null)).subscribe(received => {
            ...
            it('should update a Voyage', () => {
                service.update(new Voyage(123)).subscribe(received => {
