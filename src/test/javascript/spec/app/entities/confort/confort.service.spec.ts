    ...
    describe('Confort Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/conforts';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Confort', () => {
                service.create(new Confort(null)).subscribe(received => {
            ...
            it('should update a Confort', () => {
                service.update(new Confort(123)).subscribe(received => {
