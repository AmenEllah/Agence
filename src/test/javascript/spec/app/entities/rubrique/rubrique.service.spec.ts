    ...
    describe('Rubrique Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/rubriques';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Rubrique', () => {
                service.create(new Rubrique(null)).subscribe(received => {
            ...
            it('should update a Rubrique', () => {
                service.update(new Rubrique(123)).subscribe(received => {
