...
import com.amenellah.repository.ImageRepository;
...
public class ImageResourceIntTest {
    ...
    private static final byte[] UPDATED_NAME = TestUtil.createByteArray(2, "1");
    ...
    public void createImage() throws Exception {
        ...
        assertThat(testImage.getNameContentType()).isEqualTo(DEFAULT_NAME_CONTENT_TYPE);
    }
    ...
    public void updateImage() throws Exception {
        ...
        assertThat(testImage.getNameContentType()).isEqualTo(UPDATED_NAME_CONTENT_TYPE);
    }
